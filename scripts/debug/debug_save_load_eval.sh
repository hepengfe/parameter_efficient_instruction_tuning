...
# CUDA_VISIBLE_DEVICES=0  WANDB_MODE=disabled python prompt_tuning.py --model_name_or_path google/t5-small-lm-adapt --model_arch encoder-decoder --per_device_train_batch_size 2 --per_device_eval_batch_size 1 --tuning_mode adapter --learning_rate 3e-4 --max_steps 3 --dataset_name ni --data_dir data/splits/default --task_dir data/tasks --predict_with_generate  --bf16 --reduction_factor 20 --dev --max_num_instances_per_eval_task 10  > debug_save_load_eval.log
